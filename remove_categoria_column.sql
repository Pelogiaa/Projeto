-- Script para remover apenas a coluna categoria da tabela tab_servicos
-- Remove: categoria
-- Mantém: id, nome, preco, data_cadastro, descricao, observacoes, status, data_atualizacao
...
-- Remover apenas a coluna categoria
