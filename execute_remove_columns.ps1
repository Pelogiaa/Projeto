# =====================================================
# SCRIPT PARA REMOVER COLUNAS DA TABELA SERVICOS
# Projeto: Clinica Veterinaria
# =====================================================

Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host "    REMOVENDO COLUNAS DA TABELA SERVICOS" -ForegroundColor Cyan
Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($psqlPath) {
    ...
    Write-Host "Executando script SQL para remover colunas..." -ForegroundColor Yellow
    try {
        & $psqlPath -h localhost -U postgres -d projeto_clinica_veterinaria -f remove_columns_servicos.sql
    ...
    Write-Host "4. Copie e cole o conteúdo do arquivo 'remove_columns_servicos.sql'" -ForegroundColor Gray
    ...
    Write-Host "=====================================================" -ForegroundColor Cyan
    Get-Content "remove_columns_servicos.sql" | Write-Host
}
