# =====================================================
# ATUALIZAR TABELA TAB_SERVICOS
# Script PowerShell para executar atualizações no banco
# =====================================================

Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host "    ATUALIZANDO TABELA TAB_SERVICOS" -ForegroundColor Cyan
Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Executando atualização da tabela tab_servicos..." -ForegroundColor Yellow
try {
...
Write-Host "=====================================================" -ForegroundColor Green
Write-Host "A tabela tab_servicos foi atualizada com a estrutura final." -ForegroundColor Cyan
Write-Host ""
